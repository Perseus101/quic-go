...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/perseus101/quic-go/internalpackage
...
cp -r $GOPATH/src/github.com/perseus101/quic-go/internal/* $TEMP_DIR/src/github.com/perseus101/quic-go/internalpackage
